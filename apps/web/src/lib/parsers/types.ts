...
export const StatsCacheSchema = z.object({
  ...
  toolFrequency: z.record(z.string(), z.number()).optional(),
  agentDispatches: z.record(z.string(), z.number()).optional(),
  skillInvocations: z.record(z.string(), z.number()).optional(),
  planModeCount: z.number().optional(),
})
