...
import { getSessionList, getActiveSessionList, getPaginatedSessions, getRecentPrompts } from './sessions.api'
...
export const recentPromptsQuery = queryOptions({
  queryKey: ['sessions', 'recentPrompts'],
